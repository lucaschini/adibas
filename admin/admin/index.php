				...
				<main class="form-signin w-100 m-auto" style="display:flex; flex-direction:column; align-items:center; gap:2rem; text-align:center;">
					...
					<div style="display:flex; flex-direction:column; gap:2rem; ">
						...
						if (($_SESSION["funcao"] === "gerente")) { ?>
							...
							<form action="financeiro.html">
								<button type="submit" class="w-100 btn btn-lg btn-secondary" type="submit">Financeiro</button>
							</form>
							<form action="expedi.html">
								<button type="submit" class="w-100 btn btn-lg btn-secondary" type="submit">Expedição</button>
							</form>
