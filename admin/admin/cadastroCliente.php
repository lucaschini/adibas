			...
			<div class="row align-items-center rounded-3 border shadow-lg bg-white" style="padding: 2rem; justify-content: space-around">
				...
				<div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
					<main class="form-signin w-100 m-auto">
						<h1 class="display-4 fw-bold lh-1">Cadastro</h1>
						<form action="cadastroCliente.php" method="post" onsubmit="verificarDados()">
							...
							<div class="form-floating" style="margin-top: 1rem">
								<input type="password" class="form-control" id="input-senha" placeholder="Password" name="senha" />
								<label for="floatingPassword">Senha</label>
							</div>

							<div class="form-floating" style="margin-top: 1rem">
								<input type="Text" class="form-control" id="input-nome" name="nome" placeholder="Name" />
							...
							<button class="w-100 btn btn-lg btn-primary" style="margin-top: 1rem" type="submit">Cadastrar</button>
